...
import javafx.fxml.FXML;
 ...
 public class PaginaPrincipalController{
    ...
    App app;
     ...
     void initialize() {
         assert btnvehiculos != null : "fx:id=\"btnvehiculos\" was not injected: check your FXML file 'PaginaPrincipal.fxml'.";
         assert btnclientes != null : "fx:id=\"btnclientes\" was not injected: check your FXML file 'PaginaPrincipal.fxml'.";
         assert btnreservas != null : "fx:id=\"btnreservas\" was not injected: check your FXML file 'PaginaPrincipal.fxml'.";
